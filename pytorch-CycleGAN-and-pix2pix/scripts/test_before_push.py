...
if __name__ == '__main__':
    ...
    if not os.path.exists('./checkpoints/horse2zebra_pretrained/beaches2_model.pth'):
    ...
    if not os.path.exists('./checkpoints/facades_label2photo_pretrained/beaches2_model.pth'):
